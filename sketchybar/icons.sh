...
export ICON_GOOGLE_CHROME=󰊯
export ICON_GOOGLE_GMAIL=󰊫
export ICON_GOOGLE_CALENDAR=󰸗
export ICON_ANDROID_STUDIO=󰀴
export ICON_VS_CODE=󰘐
export ICON_SLACK=󰒱
export ICON_SPOTIFY=󰓇
export ICON_JIRA=󰌃
export ICON_NOTION=󱓧
